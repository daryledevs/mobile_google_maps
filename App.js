...
const App = () => {
  ...
  const userCoor = [{x: 14.111, y: 120.93}];
  const clinics = [
          ...
          <View style={{flex: 1}}>
            <MapView
              ...
              <Marker
                ...
                onDragEnd={value =>
                  setMarkerLocation(value.nativeEvent.coordinate)
                }
              />
            ...
            <View
              ...
              <GooglePlacesAutocomplete
                ...
                ref={reference => {
                  ...
                  if (reference?.isFocused() === false)
                    setIsSearchbarFocus(false);
                  autocompleteRef.current = reference;
                  // isKeyboardVisible
                }}
                getDefaultValue={() => ''}
            ...
            {/* <View style={styles.coordinateContainer}>
              ...
              <Text style={styles.text}>
                Latitude: {changeLocation.longitude}
              </Text>
